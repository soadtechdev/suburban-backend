  ...
  var e = {
      152: function (e, t, r) {
        ...
        const i = r(127),
          ...
          p = a(r(498)),
          _ = i.Router()
        _.use('/', p.default(f.default.headers, p.ValidationSource.HEADER), async (e, t, r) => {
          const o = e.get('Authorization'),
            [, n] = o.split(' ')
          try {
            u.default.verify(n, d.secretKey), (e.body.session = u.default.decode(n)), r()
          } catch (e) {
      ...
      498: function (e, t, r) {
        ...
        !(function (e) {
          ...
          (t.default = (e, t = s.BODY) => (r, o, n) => {
            ...
            const { details: i } = s,
              u = i.map((e) => e.message.replace(/['"]+/g, '')).join(',')
            return a.BadRequestError(o, u)
          })
      },
      547: function (e, t, r) {
        var o =
          ...
          (t.changeStatusOrder = async (e, t) => {
            ...
            switch (r) {
              case s.StatusService.ACEPTADO:
                try {
                  const e = await i.acceptOrder(Number(u), r, o)
                  a.SuccessResponse(t, 'success', { data: { order: e } })
                } catch (e) {
                  a.InternalError(t)
                }
              ...
              case s.StatusService.CANCELADO:
                try {
                  const e = await i.finished(Number(u), r, n)
                  a.SuccessResponse(t, 'success', { data: { order: e } })
                } catch (e) {
                  a.InternalError(t)
                }
      ...
      803: function (e, t, r) {
        ...
        const i = r(127),
          ...
          c = s(r(251)),
          l = i.Router()
        l.post('/create', u.default(c.default.create), d.createEncargo), l.post('/:id', u.default(c.default.changeStatusOrder), d.changeStatusOrder), (t.default = l)
      },
      594: function (e, t, r) {
        var o =
          (this && this.__importDefault) ||
        ...
        t.default = async (e, t) => {
          try {
            ...
            const i = { ...a }
            delete i.password
            const u = s.signToken(i)
            return n.SuccessResponse(t, 'Signup Successful', { data: { user: i, token: u } })
          } catch (e) {
      ...
      992: function (e, t, r) {
        ...
        const i = r(127),
          ...
          l = s(r(498)),
          f = i.Router()
        f.post('/signup', l.default(c.default.signup), u.validateEmailUser, u.createUser), f.post('/login', l.default(c.default.login), d.default), (t.default = f)
      },
      902: function (e, t, r) {
        var o =
          (this && this.__importDefault) ||
        ...
        const n = r(127),
          ...
          i = o(r(547)),
          u = n.Router()
        u.use('/auth', a.default), u.use('/admin', s.default, i.default), (t.default = u)
      },
      752: function (e, t, r) {
        var o =
          (this && this.__importDefault) ||
        ...
        ;(async function () {
          const e = n.default()
          e.use(n.default.static(`${__dirname}/public`)), await r(871).default({ expressApp: e })
          const t = s.default.createServer(e)
          i.default.getInstance().setIo(t),
            i.default.getInstance().hearSocket(),
            e
              .listen(u.port, () => {
                d.default.info(
                  `${a.default.yellow('########################################################')}\n🛡️  ${a.default.green(`Server ${a.default.blue(u.name)} listening on port:`)} ${a.default.blue(u.port)} 🛡️\n${a.default.yellow('########################################################')}`
                )
              })
      ...
      871: function (e, t, r) {
        ...
        t.default = async ({ expressApp: e }) => {
          ...
          try {
            await i.pool.connect(), s.default.info(n.default.green('PostgreSQL loaded and connected! ✌️'))
          } catch (e) {
      ...
      306: function (e, t, r) {
        ...
        const n = o(r(563)),
          ...
          s = r(275),
          i = o(r(976)),
          { user: u, password: d, host: c, database: l, port: f } = s.db,
          p = { user: u, password: d, host: c, database: l, port: +f, max: 5, idleTimeoutMillis: 4e4 }
        ;(t.pool = new a.Pool(p)),
          t.pool.on('connect', () => {}),
          t.pool.on('error', (e, t) => {
            let r
      ...
      334: function (e, t, r) {
        ...
        t.default = class {
          constructor() {
            ;(this.setIo = (e) => {
              this.io = new i.Server(e, { cors: { origin: '*' } })
            }),
              (this.getIo = () => this.io),
              (this.hearSocket = () => {
                u.default.info(c.default.green('Escuchando la conexion del socketIO')),
                  this.io.on('connection', (e) => {
                    u.default.info(c.default.green('Un usuario connectado')), d.connectClient(e, this.io), d.disconnect(e, this.io)
                  })
              })
          }
          static getInstance() {
        ...
        class u {
          constructor() {
            ;(this.findByEmail = async (e) => {
              const { rows: t } = await s.pool.query(i.findByEmail, [e])
              return t[0]
            }),
              (this.save = async ({ nombre: e, apellido: t, celular: r, password: o, correo: n, imagen: a, tipo: u }) => {
                const { rows: d } = await s.pool.query(i.save, [e, t, a, n, r, o, u])
        ...
        class u {
          constructor() {
            ;(this.createOrder = async (e, t, r) => {
              const { rows: o } = await s.pool.query(i.createOrder, [e, t, r])
              return o[0]
            }),
              (this.acceptOrder = async (e, t, r) => {
                const { rows: o } = await s.pool.query(i.changeStatus, [t, r, e])
                return o[0]
              }),
              (this.finished = async (e, t, r) => {
                const { rows: o } = await s.pool.query(i.declineOrder, [t, r, e])
                return o[0]
              })
          }
          static getInstance() {
        ...
        class l {
          constructor() {
            ;(this.findByEmail = async (e) => {
              ...
              (this.save = async ({ nombre: e, apellido: t, celular: r, correo: o, password: a, imagen: i, tipo: u }) => {
                try {
                  const n = await s.default.hash(a, 10)
                  return await c.save({ nombre: e, apellido: t, celular: r, password: n, correo: o, imagen: i, tipo: u })
                } catch (e) {
              ...
              (this.signToken = (e) => a.default.sign(e, i.secretKey, { expiresIn: '24h' })),
              (this.verifyToken = (e) => a.default.verify(e, i.secretKey))
          }
          static getInstance() {
      ...
      91: function (e, t, r) {
        ...
        class u {
          constructor() {
            ;(this.createOrder = async (e, t, r) => {
              try {
                return await i.createOrder(e, t, r)
              } catch (e) {
              ...
              (this.acceptOrder = async (e, t, r) => {
                try {
                  return await i.acceptOrder(e, t, r)
                } catch (e) {
                  throw (s.default.error(n.default.red('Error OrderService findByEmail '), e), new Error('ERROR TECNICO'))
                }
              }),
          ...
          static getInstance() {
            return void 0 === u.instance && (u.instance = new u()), u.instance
          }
        }
        t.default = u
      },
